    ...
    <div class="col-sm-10 content" style="background-color:rgb(252, 252, 252);">
        ...
        <div class="search-container" style="height: 5% ; margin-bottom: 50px;">
           <form action="" method="get">
            <input type ="text" name ="search" placeholder="Nhap tu khoa" value="<?php if(isset($_GET["search"])) {echo $_GET["search"];}?> ">
            <input type ="submit" value = "TIm">
           <!-- <input type="text" id="searchCode" placeholder="Tìm kiếm..." name ="search" value =""> -->
