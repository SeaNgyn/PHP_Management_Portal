...
try {
  ...
  $sql = "SELECT * FROM giang_vien limit $begin,$limit";
  $statement = $connection->prepare($sql);
  $statement->execute();
    ...
    <div class="col-sm-10 content" style="background-color:rgb(252, 252, 252);">
        ...
        <div class="panel panel-primary " style="margin-top: 20px; height: auto; ">
            <div class="panel-heading"
                style="height: auto; font-size: 20px; font-family: Helvetica; color: white;background-color:blue">Danh sách môn học được phân công </div>
